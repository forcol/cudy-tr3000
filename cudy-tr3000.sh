...
CONFIG_TARGET_PROFILE="DEVICE_cudy_tr3000-v1-ubootmod"
...
# Boot Loaders
#
CONFIG_PACKAGE_trusted-firmware-a-mt7981-cudy-tr3000-v1=y
...
CONFIG_PACKAGE_u-boot-mt7981_cudy_tr3000-v1=y
# end of Boot Loaders
